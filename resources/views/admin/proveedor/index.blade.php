...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex aling-items-center flex-wrap">
            <h4>Proveedores</h4>
            @can('add proveedores')
                <a class="btn btn-warning ml-4" href="{{ url('/crear-proveedor') }}"><i class="fa fa-plus"
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <div class="d-flex pl-2 flex-column align-items-start justify-content-center">
                                            ...
                                            @can('edit proveedores')
                                                <a href="{{ url('edit-prov/' . $item->id) }}" class="btn mb-1 btn-primary"><i
                                                        class="fas fa-edit"></i>Editar</a>
                                            @endcan
                                            @can('destroy proveedores')
                                                <a href="{{ url('delete-prov/' . $item->id) }}"
