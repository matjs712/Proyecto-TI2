...
<div class="card">
    ...
    <div class="card-body">
        <table style="width: 100%;" class="table" id="tablaCategorias">
            ...
            <tbody>
                ...
                <tr class="text-center"> 
                    ...
                    <td>{!! ($categoria->status == 0)? '<span class="badge badge-success">Visible</span>' : '<span class="badge badge-danger">No visible</span>' !!}</td>
                    <td>{!! ($categoria->poular == 0)? '<span class="badge badge-danger">No</span>':'<span class="badge badge-success">Si</span>'  !!}</td>
                    <td>
