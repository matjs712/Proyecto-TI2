...
@section('content')
    ...
    <div class="container">
        ...
        {{-- Comprobante de pago --}}
        <div id="pdf" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="qrModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content h-100">
                    <div class="modal-header">
        ...
        <script>
            ...
            function actualizarListaProductos(productos) {
                ...
                productos.forEach(function(producto) {
                    ...
                    let image = $('<img>').addClass('img-fluid rounded-start').attr('src',
                        '<?= Storage::url("uploads/productos/' + producto.image + '") ?>').attr('alt',
                        'Product Image');
                    ...
                    let deleteBtn = $('<button>').addClass('btn btn-danger mb-3 mr-3').append($('<i>').addClass(
                        'fa fa-trash'));
                ...
                $('#precio').html('$ ' + precio);
                document.getElementById('productos-container').scrollTop = document.getElementById('productos-container')
                    .scrollHeight;
            }
            ...
            $('.btnPagar').click(function(e) {
                        ...
                        function actualizarListaProductos(productos) {
                            ...
                            container.empty();
                            productos.forEach(function(producto) {
                                let card = $('<div>').addClass('card my-2').attr('id', producto.id).css('max-width',
                                    '640px');
                                let row = $('<div>').addClass('row g-0');
                                let imageCol = $('<div>').addClass('col-md-4');
                                let image = $('<img>').addClass('img-fluid rounded-start').attr('src',
                                ...
                                let cardTitle = $('<h5>').addClass('card-title').text(producto.name);
                                let cardText = $('<p>').addClass('card-text').text(producto.description);
                                let ctaSection = $('<div>').addClass(
                                    'col-md-2 d-flex flex-column justify-content-between');
                                let price = $('<p>').addClass('mt-4 mb-0 text-end').text(producto.selling_price);
                                precio += parseInt(producto.selling_price);
                                let deleteBtn = $('<button>').addClass('btn btn-danger mb-3 mr-3').append($('<i>')
                                    .addClass(
                                        'fa fa-trash'));
                            ...
                            $('#precio').html('$ ' + precio);
                            document.getElementById('productos-container').scrollTop = document.getElementById(
                                    'productos-container')
                                .scrollHeight;
                        }
